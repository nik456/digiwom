...
<body>
	...
	<div class="bg-contact100" style="background-image: url('assets/img/bg/bg-1.jpg');">
		<div class="container-contact100">
			...
			<div class="wrap-contact100">
				<h3>Email Sent Successfully Please reset your password.</h3>
                <a class="btn btn-primary" href="index.php">To Homepage</a>
