...
?>
<form method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure you want to submit this form?');">
<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body"><button id="m_aside_left_close_btn" class="m-aside-left-close m-aside-left-close--skin-dark"><i class="la la-close"></i></button>
    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper"><div class="m-subheader "><div class="d-flex align-items-center"><div class="mr-auto"><h3 class="m-subheader__title m-subheader__title--separator">New Survey</h3> <ul class="m-subheader__breadcrumbs m-nav m-nav--inline"><li class="m-nav__item m-nav__item--home"><a href="" class="m-nav__link m-nav__link--icon"><i class="m-nav__link-icon la la-home"></i></a></li> <li class="m-nav__separator">-</li> <li class="m-nav__item"><a href="/dashboard" class="m-nav__link"><span class="m-nav__link-text">Dashboard</span></a></li> <li class="m-nav__separator">-</li> <li class="m-nav__item"><a href="/advertiser/campaigns" class="m-nav__link"><span class="m-nav__link-text">Create</span></a></li> <li class="m-nav__separator">-</li> <li class="m-nav__item"><span class="m-nav__link-text">New Survey</span></li></ul></div> <div></div></div></div> <div class="m-content"><div id="errors" style="visibility: hidden; height: 0px;"></div> <!----> <div><div class="m-portlet"><div class="m-portlet__head m--bg-custom-light-blue"><div class="m-portlet__head-caption"><div class="m-portlet__head-title align-items-center"><span class="m-portlet__head-icon text-dark"><i class="flaticon-cogwheel-2"></i></span> <h3 class="m-portlet__head-text text-dark">General Survey Settings</h3></div></div></div> <div class="m-portlet__body"><div class="m-form m-form--state"><div class="row"><div class="col">
    <div class="form-group m-form__group"><label for="form-control-name">
    Survey name
    </label> <input placeholder="Survey name" name="adName" id="form-control-name" type="text" class="form-control m-input m-input--air"  required> <!----></div>     
    <div class="form-group m-form__group"><label for="form-control-name">
    <!--Select Campaign -->
    </label> 

 <select class="form-control" name="campaignAssign" onchange="showUser(this.value)">
        <option value="" disabled selected>Select your campaign</option>
       <?php listAsignToCampaign(); ?>
    </select>


     <!----></div> 
<label class="form-control-label"> </label> <div data-v-a6bdf47c="" class="form-group m-form__group"><!----> <!----> <div data-v-a6bdf47c=""></div>
     <div data-v-a6bdf47c="" class="mt-3"></div> <!----> <!----></div></div> <div class="col"><div class="form-group m-form__group m-select2 m-select2--air"><label for="form-control-frequency_cap">
    Frequency cap
    </label> 
    ...
    Time zone
     ...
     Daily budget, $ less than shown on the left side of the screen.
        ...
        </div></div></div></div> <div class="col"><div class="m-portlet"><div class="m-portlet__head m--bg-custom-light-blue"><div class="m-portlet__head-caption"><div class="m-portlet__head-title align-items-center"><span class="m-portlet__head-icon text-dark"><i class="la la-globe"></i></span> <h3 class="m-portlet__head-text text-dark">Subscription Age Targeting (days)</h3></div></div></div> <div class="m-portlet__body"><div class="m-form m-form--state"><div class="form-group m-form__group align-items-center mx-0 row"><div class="input-group"><div class="input-group-append"><div class="form-group m-form__group"><label class="mt-5" for="form-control-target_subscription_age_from">
  ...
  <div class="m-portlet"><div class="m-portlet__head m--bg-custom-light-blue"><div class="m-portlet__head-caption"><div class="m-portlet__head-title align-items-center"><span class="m-portlet__head-icon text-dark"><i class="la la-money"></i></span> <h3 class="m-portlet__head-text text-dark">Other parameters targeting:</h3></div></div></div> <div class="m-portlet__body"><div class="m-form m-form--state"><div class="row"><div class="col"><div class="form-group m-form__group"><label for="">
    ...
    Parameters targeting
     ...
     <div class="m-portlet"><div class="m-portlet__head m--bg-custom-light-blue"><div class="m-portlet__head-caption"><div class="m-portlet__head-title align-items-center"><span class="m-portlet__head-icon text-dark"><i class="la la-list-alt"></i></span> <h3 class="m-portlet__head-text text-dark">Upload Content</h3></div></div>
        ...
        <div class="mx-0 ">
            <h2 class  ="ml-4">Multy Style Questions</h2>
            <div class="row ml-2 ">
                
                <div class="col-lg-3 mt-3" id="QuestionMulti">
                            <label class="form-control-label" id="QuestionMulti">Question: <span class="tx-danger">*</span></label>
                      </div>
                      <div class="col-lg-2 mt-3" id="Answer1Multi">
                            <label class="form-control-label" id="Answer1Multi">Answer 1: <span class="tx-danger">*</span></label>
                      </div>
                        <div class="col-lg-2 mt-3" id="Answer2Multi">
                            <label class="form-control-label" id="Answer2Multi">Answer 2: <span class="tx-danger">*</span></label>
                      </div>
                        <div class="col-lg-2 mt-3" id="Answer3Multi">
                            <label class="form-control-label" id="Answer3Multi">Answer 3: <span class="tx-danger">*</span></label>
                      </div><div class="col-lg-2 mt-3" id="Answer4Multi">
                            <label class="form-control-label" id="Answer4Multi">Answer 4: <span class="tx-danger">*</span></label>
                      </div>
                  <input class="btn btn-success  mt-3 mb-3 ml-3 " type="button" value="Add Multiple Choice style questions" onclick="multichoice()">
                  
            </div>
            
                <h2 class  ="ml-4">Checkbox Style Questions</h2>
            <div class="row ml-2">
                <div class="col-lg-3 mt-3" id="Question">
                            <label class="form-control-label" id="Question">Question: <span class="tx-danger">*</span></label>
                      </div>
                      <div class="col-lg-2 mt-3" id="Answer1">
                            <label class="form-control-label" id="Answer1">Answer 1: <span class="tx-danger">*</span></label>
                      </div>
                        <div class="col-lg-2 mt-3" id="Answer2">
                            <label class="form-control-label" id="Answer2">Answer 2: <span class="tx-danger">*</span></label>
                      </div>
                        <div class="col-lg-2 mt-3" id="Answer3">
                            <label class="form-control-label" id="Answer3">Answer 3: <span class="tx-danger">*</span></label>
                      </div>
                      <div class="col-lg-2 mt-3" id="Answer4">
                            <label class="form-control-label" id="Answer4">Answer 4: <span class="tx-danger">*</span></label>
                      </div>
                  <input class="btn btn-success  mt-3 mb-3 ml-3 " type="button" value="Add Checkboxes style questions" onclick="features()">
            </div> 
                   <h2 class="ml-4">Dropdown Style Questions</h2>
            <div class="row ml-2">
                <div class="col-lg-3 mt-3" id="QuestionDropdown">
                            <label class="form-control-label" id="QuestionDropdown">Question: <span class="tx-danger">*</span></label>
                      </div>
                      <div class="col-lg-2 mt-3" id="Answer1Dropdown">
                            <label class="form-control-label" id="Answer1Dropdown">Answer 1: <span class="tx-danger">*</span></label>
                      </div>
                        <div class="col-lg-2 mt-3" id="Answer2Dropdown">
                            <label class="form-control-label" id="Answer2Dropdown">Answer 2: <span class="tx-danger">*</span></label>
                      </div>
                        <div class="col-lg-2 mt-3" id="Answer3Dropdown">
                            <label class="form-control-label" id="Answer3Dropdown">Answer 3: <span class="tx-danger">*</span></label>
                      </div>
                      <div class="col-lg-2 mt-3" id="Answer4Dropdown">
                            <label class="form-control-label" id="Answer4Dropdown">Answer 4: <span class="tx-danger">*</span></label>
                      </div>
                  <input class="btn btn-success  mt-3 mb-3 ml-3 " type="button" value="Add Checkboxes style questions" onclick="dropdown()">
            </div> 
        </div>
     </div>
...
<script>
        function  features() {
            ...
            elementToCreate1 = document.createElement("input");
            elementToCreate1.setAttribute("type","text");
            elementToCreate1.setAttribute("id","t1");
            elementToCreate1.setAttribute("name","checkboxQuestion[]");
            elementToCreate1.setAttribute("class"," form-control mt-3");

            Answer1= document.getElementById("Answer1");


            elementToCreate2 = document.createElement("input");
            elementToCreate2.setAttribute("type","text");
            elementToCreate2.setAttribute("id","t1");
            elementToCreate2.setAttribute("name","checkboxAnswer1[]");
            elementToCreate2.setAttribute("class"," form-control mt-3");

            Answer2= document.getElementById("Answer2");


            elementToCreate3 = document.createElement("input");
            elementToCreate3.setAttribute("type","text");
            elementToCreate3.setAttribute("id","t1");
            elementToCreate3.setAttribute("name","checkboxAnswer2[]");
            elementToCreate3.setAttribute("class"," form-control mt-3");
            
            Answer3= document.getElementById("Answer3");


            elementToCreate4 = document.createElement("input");
            elementToCreate4.setAttribute("type","text");
            elementToCreate4.setAttribute("id","t1");
            elementToCreate4.setAttribute("name","checkboxAnswer3[]");
            elementToCreate4.setAttribute("class"," form-control mt-3");
            
            Answer4= document.getElementById("Answer4");


            elementToCreate5 = document.createElement("input");
            elementToCreate5.setAttribute("type","text");
            elementToCreate5.setAttribute("id","t1");
            elementToCreate5.setAttribute("name","checkboxAnswer4[]");
            elementToCreate5.setAttribute("class"," form-control mt-3");
            
            

            Question.appendChild(elementToCreate1);
            Answer1.appendChild(elementToCreate2);
            Answer2.appendChild(elementToCreate3);
            Answer3.appendChild(elementToCreate4);
            Answer4.appendChild(elementToCreate5);
        }
        
        function  multichoice() {
            QuestionMulti= document.getElementById("QuestionMulti");


            elementToCreate1 = document.createElement("input");
            elementToCreate1.setAttribute("type","text");
            elementToCreate1.setAttribute("id","t1");
            elementToCreate1.setAttribute("name","multichoiceQuestion[]");
            elementToCreate1.setAttribute("class"," form-control mt-3");

            Answer1Multi= document.getElementById("Answer1Multi");


            elementToCreate2 = document.createElement("input");
            elementToCreate2.setAttribute("type","text");
            elementToCreate2.setAttribute("id","t1");
            elementToCreate2.setAttribute("name","multichoiceAnswer1[]");
            elementToCreate2.setAttribute("class"," form-control mt-3");

            Answer2Multi= document.getElementById("Answer2Multi");


            elementToCreate3 = document.createElement("input");
            elementToCreate3.setAttribute("type","text");
            elementToCreate3.setAttribute("id","t1");
            elementToCreate3.setAttribute("name","multichoiceAnswer2[]");
            elementToCreate3.setAttribute("class"," form-control mt-3");
            
            Answer3Multi= document.getElementById("Answer3Multi");


            elementToCreate4 = document.createElement("input");
            elementToCreate4.setAttribute("type","text");
            elementToCreate4.setAttribute("id","t1");
            elementToCreate4.setAttribute("name","multichoiceAnswer3[]");
            elementToCreate4.setAttribute("class"," form-control mt-3");
            
            Answer4Multi= document.getElementById("Answer4Multi");


            elementToCreate5 = document.createElement("input");
            elementToCreate5.setAttribute("type","text");
            elementToCreate5.setAttribute("id","t1");
            elementToCreate5.setAttribute("name","multichoiceAnswer4[]");
            elementToCreate5.setAttribute("class"," form-control mt-3");
            
            

            QuestionMulti.appendChild(elementToCreate1);
            Answer1Multi.appendChild(elementToCreate2);
            Answer2Multi.appendChild(elementToCreate3);
            Answer3Multi.appendChild(elementToCreate4);
            Answer4Multi.appendChild(elementToCreate5);
        }
        
        function  dropdown() {
            QuestionDropdown= document.getElementById("QuestionDropdown");


            elementToCreate1 = document.createElement("input");
            elementToCreate1.setAttribute("type","text");
            elementToCreate1.setAttribute("id","t1");
            elementToCreate1.setAttribute("name","dropdownQuestion[]");
            elementToCreate1.setAttribute("class"," form-control mt-3");

            Answer1Dropdown= document.getElementById("Answer1Dropdown");


            elementToCreate2 = document.createElement("input");
            elementToCreate2.setAttribute("type","text");
            elementToCreate2.setAttribute("id","t1");
            elementToCreate2.setAttribute("name","dropdownAnswer1[]");
            elementToCreate2.setAttribute("class"," form-control mt-3");

            Answer2Dropdown= document.getElementById("Answer2Dropdown");


            elementToCreate3 = document.createElement("input");
            elementToCreate3.setAttribute("type","text");
            elementToCreate3.setAttribute("id","t1");
            elementToCreate3.setAttribute("name","dropdownAnswer2[]");
            elementToCreate3.setAttribute("class"," form-control mt-3");
            
            Answer3Dropdown= document.getElementById("Answer3Dropdown");


            elementToCreate4 = document.createElement("input");
            elementToCreate4.setAttribute("type","text");
            elementToCreate4.setAttribute("id","t1");
            elementToCreate4.setAttribute("name","dropdownAnswer3[]");
            elementToCreate4.setAttribute("class"," form-control mt-3");
            
            Answer4Dropdown= document.getElementById("Answer4Dropdown");


            elementToCreate5 = document.createElement("input");
            elementToCreate5.setAttribute("type","text");
            elementToCreate5.setAttribute("id","t1");
            elementToCreate5.setAttribute("name","dropdownAnswer4[]");
            elementToCreate5.setAttribute("class"," form-control mt-3");
            
            

            QuestionDropdown.appendChild(elementToCreate1);
            Answer1Dropdown.appendChild(elementToCreate2);
            Answer2Dropdown.appendChild(elementToCreate3);
            Answer3Dropdown.appendChild(elementToCreate4);
            Answer4Dropdown.appendChild(elementToCreate5);
        }
</script>
<!-- begin::Quick Sidebar -->
<!-- end::Body -->
