<html>
  <head>
      ...
      <title>Digiwom Checkout with PayPal</title>
  ...
  <body>
      <div class="container-fluid">
          <div class="well bg-color">
              <h2 class="text-center">Digiwom Checkout with PayPal</h2>
              <h4 class="text-center">Hope you are having an amazing day</h4>
          </div>
      </div>
