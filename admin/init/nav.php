            ...
            <div id="m_header_topbar" class="m-topbar  m-stack m-stack--ver m-stack--general text-right">
               <div class="m-stack__item m-topbar__nav-wrapper d-inline-flex">
                  <ul class="m-topbar__nav m-nav m-nav--inline mx-auto">
                      <div class="dropdown">
                      <button class="btn btn-secondary dropdown-toggle" style="margin-top: 4px;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
         ...
         <div id="mCSB_2_container" class="mCSB_container mCS_y_hidden mCS_no_scrollbar_y" style="position:relative; top:0; left:0;" dir="ltr">
            <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
               ...
               <li class="m-menu__section">
                  <h4 class="m-menu__section-text ">ADVERTISER ACCOUNT</h4>
               </li>
               <li aria-haspopup="true" class="m-menu__item "><a href="simulation_tool.php" class="m-menu__link "><i class="m-menu__link-icon flaticon-coins "></i><span class="m-menu__link-title"><span class="m-menu__link-wrap"><span class="m-menu__link-text ">Simulation tool</span><span class="m-menu__link-badge"></span></span></span></a></li>

               <li aria-haspopup="true" data-menu-submenu-toggle="hover" class="m-menu__item  m-menu__item--submenu ">
                  <a href="" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-clipboard "></i><span class="m-menu__link-title"><span class="m-menu__link-wrap"><span class="m-menu__link-text">List</span><span class="m-menu__link-badge"></span></span></span><i class="m-menu__ver-arrow la la-angle-right"></i></a>
                  <div class="m-menu__submenu ">
                     <span class="m-menu__arrow"></span>
                     <ul class="m-menu__subnav">
                        <!--<li aria-haspopup="true" class="m-menu__item "><a href="list_campaign.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">List Campaign</span></a></li>-->
                        <li aria-haspopup="true" class="m-menu__item "><a href="list_ad.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">List Ad</span></a></li>
                        <li aria-haspopup="true" class="m-menu__item "><a href="list_surveys.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">List Survey</span></a></li>
<!--                        <li aria-haspopup="true" class="m-menu__item "><a href="new_campaign.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Create Ad</span></a></li>-->
<!--                        <li aria-haspopup="true" class="m-menu__item "><a href="new_ad.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Create </span></a></li>-->
<!--                        <li aria-haspopup="true" class="m-menu__item "><a href="new_survey.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Create Survey</span></a></li>-->
<!--                         <li aria-haspopup="true" class="m-menu__item "><a href="#/help" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Help</span></a></li> -->
                ...
                <li aria-haspopup="true" data-menu-submenu-toggle="hover" class="m-menu__item  m-menu__item--submenu ">
                  <a href="" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-clipboard "></i><span class="m-menu__link-title"><span class="m-menu__link-wrap"><span class="m-menu__link-text">Create</span><span class="m-menu__link-badge"></span></span></span><i class="m-menu__ver-arrow la la-angle-right"></i></a>
                  <div class="m-menu__submenu ">
                     <span class="m-menu__arrow"></span>
                     <ul class="m-menu__subnav">
                        <!--<li aria-haspopup="true" class="m-menu__item "><a href="list_campaign.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">List Campaign</span></a></li>-->
                        <!--<li aria-haspopup="true" class="m-menu__item "><a href="list_ad.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">List Ad</span></a></li>-->
                        <!--<li aria-haspopup="true" class="m-menu__item "><a href="list_surveys.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">List Survey</span></a></li>-->
                        <li aria-haspopup="true" class="m-menu__item "><a href="createAdFirstQNA.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Create Ad</span></a></li>
<!--                        <li aria-haspopup="true" class="m-menu__item "><a href="new_ad.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Create </span></a></li>-->
                        <li aria-haspopup="true" class="m-menu__item "><a href="CreateSurveyFirstQNA.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Create Survey</span></a></li>
<!--                         <li aria-haspopup="true" class="m-menu__item "><a href="#/help" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Help</span></a></li> -->
                     </ul>
                  </div>
               </li>
               <li aria-haspopup="true" data-menu-submenu-toggle="hover" class="m-menu__item  m-menu__item--submenu ">
                  ...
                  <div class="m-menu__submenu ">
                     ...
                     <ul class="m-menu__subnav">
                        ...
                        <li aria-haspopup="true" class="m-menu__item "><a href="report_by_country.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">By country</span></a></li>
                        <li aria-haspopup="true" class="m-menu__item "><a href="report_by_source.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">By source</span></a></li>
                     </ul>
                  </div>
               </li>
               <li aria-haspopup="true" data-menu-submenu-toggle="hover" class="m-menu__item  m-menu__item--submenu ">
                  <a href="#" class="m-menu__link m-menu__toggle"><i class="m-menu__link-icon flaticon-list-2 "></i><span class="m-menu__link-title"><span class="m-menu__link-wrap"><span class="m-menu__link-text">Optimization</span><span class="m-menu__link-badge"></span></span></span><i class="m-menu__ver-arrow la la-angle-right"></i></a>
                  <div class="m-menu__submenu ">
                     <span class="m-menu__arrow"></span>
                     <ul class="m-menu__subnav">
                        <li aria-haspopup="true" class="m-menu__item "><a href="optimization_list.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">List</span></a></li>
                        <li aria-haspopup="true" class="m-menu__item "><a href="new_ip_list.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">New IP list</span></a></li>
                        <li aria-haspopup="true" class="m-menu__item "><a href="source_id.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">New Source ID list</span></a></li>
                        <li aria-haspopup="true" class="m-menu__item "><a href="new_isp.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">New ISP list</span></a></li>
                     </ul>
                  </div>
               </li>
               <li class="m-menu__section">
               ...
               <li aria-haspopup="true" data-menu-submenu-toggle="hover" class="m-menu__item  m-menu__item--submenu ">
                  ...
                  <div class="m-menu__submenu ">
                     <span class="m-menu__arrow"></span>
                     <ul class="m-menu__subnav">
                                <li aria-haspopup="true" class="m-menu__item "><a href="finance.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">My Wallet</span></a></li>
                         <li aria-haspopup="true" class="m-menu__item "><a href="invoices.php" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Invoices</span></a></li>
                     </ul>
                  </div>
               </li>
            </ul>
