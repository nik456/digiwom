...
<div class="m-grid__item m-grid__item--fluid m-wrapper"><div class="m-subheader "><div class="d-flex align-items-center"><div class="mr-auto"><h3 class="m-subheader__title m-subheader__title--separator">New Ip address list</h3> <ul class="m-subheader__breadcrumbs m-nav m-nav--inline"><li class="m-nav__item m-nav__item--home"><a href="" class="m-nav__link m-nav__link--icon"><i class="m-nav__link-icon la la-home"></i></a></li> <li class="m-nav__separator">-</li> <li class="m-nav__item"><a href="/dashboard" class="m-nav__link"><span class="m-nav__link-text">Dashboard</span></a></li> <li class="m-nav__separator">-</li> <li class="m-nav__item"><a href="/admin/optimisation-list" class="m-nav__link"><span class="m-nav__link-text">Optimization lists</span></a></li> <li class="m-nav__separator">-</li> <li class="m-nav__item"><span class="m-nav__link-text">New Ip address list</span></li></ul></div> <div></div></div></div> <div class="m-content"><div id="errors" style="visibility: hidden; height: 0px;"></div> <!----> <div><div class="row"><div class="col"><div class="m-portlet"><div class="m-portlet__head m--bg-custom-light-blue"><div class="m-portlet__head-caption"><div class="m-portlet__head-title align-items-center"><span class="m-portlet__head-icon text-dark"><i class="la la-home"></i></span> <h3 class="m-portlet__head-text text-dark">General Information</h3></div></div></div> <div class="m-portlet__body"><div class="m-form m-form--state"><div class="m-form__group form-group"><div class="m-form__group form-group row"> <div class="col"></label></span></div></div> <!----></div> <div class="form-group m-form__group"><label for="form-control-name">
    
    Name
    </label> <input id="form-control-name" name="name_of_ipaddress" type="text" class="form-control m-input m-input--air"> <!----></div> <div class="form-group m-form__group m-select2 m-select2--air"> <!----></div></div></div></div>
    ...
    Optimization list
        ...
        <textarea name="ipdata" id="form-control-text" rows="15" class="form-control m-input m-input--air">                    
            </textarea>
