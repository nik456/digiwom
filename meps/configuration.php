...
$configArray["gatewayUrl"] = "https://mepspay.gateway.mastercard.com/api/rest";

// Merchant ID supplied by your payments provider
$configArray["merchantId"] = "9800065100";

// API username in the format below where Merchant ID is the same as above
$configArray["apiUsername"] = "merchant.9800065100";

// API password which can be configured in Merchant Administration
$configArray["password"] = "accb40405b19919420b9ea83b59311d1";
