...
// print_r($_POST['sourceOfFunds']['provided']['card']);
...
$SESSION['number'] = $_POST['sourceOfFunds']['provided']['card']['number'];
$SESSION['month'] = $_POST['sourceOfFunds']['provided']['card']['expiry']['month'];
$SESSION['year'] = $_POST['sourceOfFunds']['provided']['card']['expiry']['year'];
$SESSION['securityCode'] = $_POST['sourceOfFunds']['provided']['card']['securityCode'];
$SESSION['amount'] = $_POST['order']['amount'];
$SESSION['currency'] =$_POST['order']['currency'];
