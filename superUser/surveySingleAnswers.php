...
$sql1= "SELECT * FROM surveyAnswers WHERE id = $id";
$r1 = mysqli_query($connect,$sql1);
    while($row1 = mysqli_fetch_array($r1)){
        $idOfSurvey = $row1['surveyId'];
        $multichoiceAnswer1 = $row1['multichoiceAnswer1'];
        $multichoiceAnswer2 = $row1['multichoiceAnswer2'];
        $multichoiceAnswer3 = $row1['multichoiceAnswer3'];
        $multichoiceAnswer4 = $row1['multichoiceAnswer4'];
        $checkboxAnswer = $row1['checkboxAnswer'];
        $dropdownAnswer = $row1['dropdownAnswer'];
    }
$item = array();

$sql= "SELECT * FROM survey WHERE id = $idOfSurvey";
...
<div class="m-grid__item m-grid__item--fluid m-wrapper"><div class="m-subheader "><div class="d-flex align-items-center"><div class="mr-auto"><h3 class="m-subheader__title m-subheader__title--separator">The Survey</h3> <ul class="m-subheader__breadcrumbs m-nav m-nav--inline"><li class="m-nav__item m-nav__item--home"><a href="" class="m-nav__link m-nav__link--icon"><i class="m-nav__link-icon la la-home"></i></a></li> <li class="m-nav__separator">-</li> <li class="m-nav__item"><span class="m-nav__link-text">The Survey</span></li></ul></div> <div></div></div></div> <div class="m-content"><div class="m-portlet"><div class="m-portlet__body"><div class="m-form m-form--state"><span class="h1">
        Ad Name:
        ...
        <div class="table-responsive">
            <div class="row">
                <div class="col-6">
                    <h3>Campaign name: <?php echo $item['campaign']; ?></h3>
            ...
            <div>
                 ...
                 <?php SyrveyAnswers($idOfSurvey,$id); ?>
