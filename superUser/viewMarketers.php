         ...
         <table class="table table-striped">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th class="text-center">Campaign Counts</th>
                    <th class="text-center">Surveys Counts</th>
                    <th class="text-center">Ads Counts</th>
                    <th class="text-center">Amount Spent</th>
                    <th class="text-center">Affiliate Number</th>
