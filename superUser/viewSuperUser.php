...
<div class="m-grid__item m-grid__item--fluid m-wrapper"><div class="m-subheader "> <div class="row">
        ...
        <div class="col-12"><div class="m-portlet"><div class="m-portlet__head m--bg-custom-light-blue"><div class="m-portlet__head-caption"><div class="m-portlet__head-title align-items-center"><h3 class="m-portlet__head-text text-dark">Super Users</h3></div></div></div> <div class="m-portlet__body">
        <div class="row">
          <table class="table table-striped" >
                <thead class="thead-dark">
                  <tr>
                    <th class="text-center">Username</th>
                    <th class="text-center">Access to Users</th>
                    <th class="text-center">Access to Campaigns,Ads and Surveys</th>
                    <th class="text-center">Access to Reports</th>
                    <th class="text-center">Access to Finances</th>
                    <th class="text-center">Access to Creating super Users</th>
