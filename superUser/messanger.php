...
require_once '../function/SuperUserController.php';
  ...
  if(isset($_POST['submit'])){
      ...
      $roomId = "chatRoom".$to_user_id;
        $sql = "INSERT INTO chat_message (isAdmin,roomKey,to_user_id,from_user_id,chat_message,timestamp,status) VALUES (0,'$roomId','$to_user_id','$from_user_id','$chat_message','$date','0') ";
        $r = mysqli_query($connect,$sql);
        if(!$r){
            var_dump($sql);
        }else{
            header("Location: messanger.php?id=".$to_user_id);
            exit();
        }
            ...
            <div class="col-md-12">
                <div class="card card-bordered">
                    ...
                    <div class="ps-container ps-theme-default ps-active-y" id="chat-content" style="overflow-y: scroll !important; height:400px !important;">
                        ...
                        <div id ="user_details">
                            <?php echo loadAdminMessages($from_user_id,$to_user_id); ?>
                        </div>
