...
require_once '../function/MarketersController.php';
  ...
  if(isset($_POST['submit'])){
      ...
      $chat_message = $_POST['bodyTextChat'];
      $date = date("Y-m-d h:i:sa");
      $roomId = "chatRoom".$to_user_id;
        $sql = "INSERT INTO chat_message (isAdmin,roomKey,to_user_id,from_user_id,chat_message,timestamp,status) VALUES (1,'$roomId','$from_user_id','$to_user_id','$chat_message','$date','0') ";
        $r = mysqli_query($connect,$sql);
        if(!$r){
            var_dump($sql);
        }else{
            header("Location: messanger.php?id=".$from_user_id);
            exit();
        }
...
<div class="m-grid__item m-grid__item--fluid m-wrapper"><div class="m-subheader "><div class="d-flex align-items-center"><div class="mr-auto"><h3 class="m-subheader__title m-subheader__title--separator">Messaging</h3> <ul class="m-subheader__breadcrumbs m-nav m-nav--inline"><li class="m-nav__item m-nav__item--home"><a href="" class="m-nav__link m-nav__link--icon"><i class="m-nav__link-icon la la-home"></i></a></li> <li class="m-nav__separator">-</li> <li class="m-nav__item"><span class="m-nav__link-text">Messaging</span></li></ul></div> <div></div></div></div> <div class="m-content"><div class="m-portlet"><div class="m-portlet__body"><div class="m-form m-form--state"><span class="h1">
        ...
        <div class="col-12"><div class="m-portlet"><div class="m-portlet__head m--bg-custom-light-blue"><div class="m-portlet__head-caption"><div class="m-portlet__head-title align-items-center"><h3 class="m-portlet__head-text text-dark">Text conversation</h3></div></div></div> <div class="m-portlet__body">
            ...
            <div class="col-md-12">
                <div class="card card-bordered">
                    ...
                    <div class="ps-container ps-theme-default ps-active-y" id="chat-content" style="overflow-y: scroll !important; height:400px !important;">
                        ...
                        <div id ='userInfo'>
                            <?php echo loadAdminToMarketerMessages($from_user_id,$to_user_id); ?>
                        </div>
                    ...
                    <div class="publisher bt-1 border-light"> 
                        ...
                        <input class="publisher-input" type="text" name="bodyTextChat" placeholder="Write something"> 
...
$(document).ready(function(){
 ...
 setInterval(function(){
  update_posted_chat_by_me();
 }, 5000);

 function update_posted_chat_by_me()
 {
  $.ajax({
  url:"update_posted_chat_by_me.php?id=<?php echo $_GET['id']; ?>",
