...
<div class="m-grid m-grid--hor m-grid--root m-page">
    ...
    <div class="m-login__signup">
        ...
        >
                ...
                <div class="form-group m-form__group">
                    <input style="padding-left: 4rem;" class="form-control m-input" type="tel" id="phone" placeholder="Phone number" name="phone" autocomplete="off"  value="" required>
                </div>
                  <div class="form-group m-form__group">
            ...
            <div class="form-group m-form__group">
                ...
                <div class="form-group m-form__group">
                <select name="country" class="select form-control countries" id="countryId">
                <option value="">Select Country</option>
                </select>
            </div>
            <div class="form-group m-form__group">
                <select name="city" class="select form-control states" id="stateId">
                <option value="">Select City</option>
                </select>
                </div>
            <div class="form-group m-form__group">
                <select name="area" class="select form-control cities" id="cityId">
            ...
            <div class="form-group m-form__group">
                            ...
                            <input type="hidden" name="mobile" value="0">
                             <div class="mt-3 text-center"><a href = "register_subscribersMobile.php" class="text-black" style="margin-top:1rem;text-align:center;">  Use Mobile Number to Register</a></div>
